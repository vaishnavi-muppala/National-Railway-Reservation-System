...
echo '<li class="active">Train Info &nbsp;</li>';
echo '</ul>';

echo "<fieldset>";
echo "<legend>Check ticket information here </legend>";
	echo "<br/> <br/> ";
	echo "<form method='POST' action='ticket_display.php'>";
	echo "PNR: <input type='text' name='pnr'><br /><br />";
	echo "<input type='submit' value='Get ticket information'>";
	echo "</form>";
echo "</fieldset> <br/> <br/> ";
